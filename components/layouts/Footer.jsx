...
function Footer() {
  return (
    <Wrapper>
      <div className="flex flex-col ipad:flex-row justify-between gap-y-12 ipad:gap-y-0 text-xl ipad:text-2xl font-normal leading-8 tracking-thiner ipad:tracking-thin">
