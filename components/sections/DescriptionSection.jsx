...
function DescriptionSection() {
  ...
  return (
    <Wrapper styles="font-normal text-2xl my-8">
      <>
        <div className="hidden ipad:grid grid-cols-3">
          <div className="hidden tablet:inline-block" />
          <div className="ipad:col-span-3 col-span-2">
          ...
          <div>
            ...
            {description === "2" && show && (
              <div className="overflow-hidden font-normal text-2xl">
                ...
                <button className="animate-dropdown">Learn more</button>
                <p className="animate-dropdown">{desc[description].end}</p>
              </div>
            )}
          </div>
          <div>
