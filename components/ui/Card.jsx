...
const Card = ({ date, title, paragraph, tags }) => {
  return (
    <div className='rounded-md max-w-[302px] ipad:max-w-[477px] min-w-[302px] ipad:min-w-[477px] ipad:max-h-[401.39px] min-h-[410px] ipad:min-h-[401.39px] border border-[#EDEDED] p-5 shadow-md'>
